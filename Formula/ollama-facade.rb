class OllamaFacade < Formula
  ...
  url "https://github.com/travis-burmaster/homebrew-ollama-facade/archive/refs/tags/v2.0.4.tar.gz"
  sha256 "4967e30b3a5fbb95fa2dd0a326d58fb2fcfd19e98a881766e29fc7ff16544b16"
  license "MIT"
  ...
  def install
    ...
    # --ignore-installed is needed because virtualenv_install_with_resources places
    # pycparser without RECORD metadata, which blocks pip from installing cffi cleanly.
    system pip, "--python=#{venv_python}", "install", "--ignore-installed", "cffi==2.0.0"
